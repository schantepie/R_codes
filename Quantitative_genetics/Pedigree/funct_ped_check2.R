...
famid=makefamid(Ped_check[,1],Ped_check[,2],Ped_check[,3])
...
colnames(Ped_check)=c("id","dam","sire")
colnames(id_female_founder)=c("id","dam","sire")
colnames(id_male_founder)=c("id","dam","sire")
Ped_check_allfound=rbind(Ped_check,id_female_founder,id_male_founder)
